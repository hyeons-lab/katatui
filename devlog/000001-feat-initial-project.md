...
**Session 8 — test assertion fixes:**
...
**Session 9 — Scrollbar, Chart, Canvas, Logo, Mascot:**
...
**Session 10 — consistent C enum prefixing:**
...
**Session 13 — expand sample app to 7 tabs:**
...
**Session 15 — Katatui Code TUI tab:**
...
**Session 16 — vertical suggestion menu:**
...
**Session 18 — MVI refactor: AppStore:**
...
**Session 19 — Picker FFI + image tab lifecycle:**
...
**Session 20 — KatatuiCode scroll + logo in paragraph:**
...
**Session 23 — event-driven render loop:**
...
**Session 24 — remove polling event API:**
...
**Session 26 — CI fix: framework on non-Apple targets:**
...
**Session 28 — CI fixes: lint, Windows, Linux cross-linker, Swift SKIE:**
...
**Session 29 — fix Windows host triple in buildKatatuiFfiHeader:**
...
**Session 30 — address PR comments:**
